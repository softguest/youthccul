...
const slides = [
  {
    ...
    description:
      "Supporting African youth to build sustainable businesses and create economic independence through accessible microfinance solutions.",
  },
  {
    image: "/img/slide02.jpg",
    title: "Agricultural Development Loans",
    description:
      "Empowering young farmers with capital and training to modernize agriculture and increase food security across African communities.",
  },
  {
    image: "/img/smallbusiness02.jpg",
    title: "Small And Medium Enterprise Growth Funding",
    description:
      "Investing in the next generation of African youth entrepreneurs to drive small and medium enterprise transformation and economic growth.",
  },
];
          ...
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <div className="flex gap-4 flex-wrap">
                <button className="bg-gradient-to-r from-green-700 via-emerald-600 to-teal-500 hover:brightness-110 text-white font-semibold py-3 px-8 rounded-md shadow-md transition">
                  Create An Account
                </button>
